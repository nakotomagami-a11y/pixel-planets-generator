const palettes = [
    ...
    },
    {
        name: "Cotton Candy",
        layers: [
            [[0.42, 0.10, 0.32], [0.56, 0.16, 0.44], [0.30, 0.06, 0.24], [0.18, 0.03, 0.14]],
            [[0.98, 0.62, 0.86], [1.00, 0.78, 0.92], [0.86, 0.40, 0.70], [0.62, 0.22, 0.50]],
            // Ring — 3 bright (rose) + 3 dark (deep magenta)
            [[1.00, 0.72, 0.90], [0.92, 0.52, 0.78], [0.78, 0.34, 0.64],
                [0.42, 0.10, 0.32], [0.28, 0.06, 0.22], [0.16, 0.03, 0.13]],
        ],
    },
    {
        name: "Jade Storm",
        layers: [
            [[0.06, 0.30, 0.26], [0.10, 0.42, 0.36], [0.04, 0.20, 0.18], [0.02, 0.12, 0.10]],
            [[0.52, 0.92, 0.78], [0.72, 1.00, 0.88], [0.34, 0.74, 0.60], [0.18, 0.52, 0.42]],
            // Ring — 3 bright (mint) + 3 dark (deep teal)
            [[0.62, 0.98, 0.84], [0.44, 0.84, 0.70], [0.28, 0.64, 0.54],
                [0.08, 0.32, 0.28], [0.05, 0.20, 0.18], [0.03, 0.12, 0.11]],
        ],
    },
];
