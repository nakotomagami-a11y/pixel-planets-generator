...
import ringedTerranPalettes from "./ringed-terran";
import toxicPalettes     from "./toxic";
import icePalettes       from "./ice";
import islandsPalettes   from "./islands";
import lavaPalettes      from "./lava";
import iceMoonPalettes   from "./ice-moon";
import eclipsePalettes   from "./eclipse";
...
import cometPalettes     from "./comet";
...
export const PLANET_TYPE_DEFS: Record<PlanetType, PlanetTypeDef> = {
  ...
  "ringed-terran": { label: "Ringed Terran", palettes: ringedTerranPalettes },
  "toxic":      { label: "Toxic World",  palettes: toxicPalettes     },
  ...
  "ice-moon":   { label: "Ice Moon",     palettes: iceMoonPalettes   },
  "eclipse":    { label: "Eclipse",      palettes: eclipsePalettes   },
  ...
  "comet":      { label: "Comet",        palettes: cometPalettes     },
};
